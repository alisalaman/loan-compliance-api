...
""",
    ...
    def test_extract_clauses_from_section_5_2a(self, parser, sample_pdf_pages):
        ...
        section_info = {"text": sample_pdf_pages[0]["text"], "pages": [41]}
    ...
    def test_extract_clauses_from_section_7(self, parser, sample_pdf_pages):
        ...
        clause_sections = {
            clause.clause_id.split()[0].split(".")[1] for clause in clauses
        }
    ...
    def test_find_subsection_name(self, parser, sample_pdf_pages):
        ...
        subsection_name = parser._find_subsection_name("7.1.1", sample_pdf_pages, [156])
    ...
    def test_custom_sections_to_extract(self):
        ...
        custom_config = ParserConfig(sections_to_extract={"5.2A": "Custom section"})
