...
from src.regulations.models import ParserConfig, ParsedDocument, DocumentMetadata, RegulationClause
...
class TestRegulationParserService:
    ...
    def test_parse_document_with_explicit_params(self, mock_create_parser, service, temp_pdf_file, mock_parsed_document):
    ...
    @patch('src.regulations.services.parser_service.ParserFactory.get_supported_types_for_jurisdiction')
    @patch('src.regulations.services.parser_service.ParserFactory.create_parser')
    def test_parse_document_with_auto_detection(self, mock_create_parser, mock_get_types, service, temp_pdf_file, mock_parsed_document):
    ...
    @patch('src.regulations.services.parser_service.ParserFactory.get_supported_types_for_jurisdiction')
    @patch('src.regulations.services.parser_service.ParserFactory.create_parser')
    def test_parse_document_file_not_found(self, mock_create_parser, mock_get_types, service):
    ...
    @patch('src.regulations.services.parser_service.ParserFactory.create_parser')
    def test_parse_document_parser_error(self, mock_create_parser, service, temp_pdf_file):
    ...
    @patch('src.regulations.services.parser_service.ParserFactory.get_all_supported_combinations')
    ...
    @patch('src.regulations.services.parser_service.ParserFactory.get_supported_jurisdictions')
    ...
    @patch('src.regulations.services.parser_service.ParserFactory.create_parser')
    def test_validate_document_with_params(self, mock_create_parser, service, temp_pdf_file):
    ...
    @patch('src.regulations.services.parser_service.ParserFactory.create_parser')
    def test_validate_document_invalid(self, mock_create_parser, service, temp_pdf_file):
    ...
    def test_validate_document_with_auto_detection(self, mock_get_parser, service, temp_pdf_file):
    ...
    def test_validate_document_exception(self, service, temp_pdf_file):
        ...
        with patch('src.regulations.services.parser_service.ParserFactory.create_parser') as mock_create:
    ...
    @patch('src.regulations.services.parser_service.ParserFactory.create_parser')
    def test_parse_timing_measurement(self, mock_create_parser, service, temp_pdf_file, mock_parsed_document):
